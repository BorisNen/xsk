...
/**
 * Copyright (c) 2010-2018 SAP and others. All rights reserved. This program and the accompanying
 * materials are made available under the terms of the Eclipse Public License v1.0 which accompanies
 * this distribution, and is available at http://www.eclipse.org/legal/epl-v10.html
 *
 * <p>Contributors: SAP - initial API and implementation
 */
...
public class XSKTableParserTest extends AbstractGuiceTest {
  ...
  @Inject private XSKDataStructuresSynchronizer dataStructuresSynchronizer;
  ...
  public void setUp() throws Exception {
    this.dataStructuresSynchronizer =
        getInjector().getInstance(XSKDataStructuresSynchronizer.class);
    ...
    try {
      ...
      try {
        ...
        XSKDataStructureHDBTableModel model =
            new XSKDataStructureModelFactory().parseTable("/Sports.hdbtable", contents);
