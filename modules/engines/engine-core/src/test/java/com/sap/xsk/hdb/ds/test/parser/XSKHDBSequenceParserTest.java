...
public class XSKHDBSequenceParserTest {
  ...
  public void parseHanav1Content() throws Exception {
    String content =
        org.apache.commons.io.IOUtils.toString(
            XSKViewParserTest.class.getResourceAsStream(
                "/test/xsk/com/sap/SampleSequence_hanav1.hdbsequence"),
            StandardCharsets.UTF_8);
    XSKDataStructureHDBSequenceModel model =
        (XSKDataStructureHDBSequenceModel)
            new XSKHDBSequenceParser()
  ...
  public void parseHanav2Content() throws Exception {
    String content =
        org.apache.commons.io.IOUtils.toString(
            XSKViewParserTest.class.getResourceAsStream(
                "/test/xsk/com/sap/CustomerId_hanav2.hdbsequence"),
            StandardCharsets.UTF_8);
    XSKDataStructureHDBSequenceModel model =
        (XSKDataStructureHDBSequenceModel)
            new XSKHDBSequenceParser()
  ...
  public void parseGrammarUnreadableContent() throws Exception {
    String content =
        org.apache.commons.io.IOUtils.toString(
            XSKViewParserTest.class.getResourceAsStream(
                "/test/xsk/com/sap/InvalidContent.hdbsequence"),
            StandardCharsets.UTF_8);
  ...
  public void parseMissingMandatoryProperty() throws Exception {
    String content =
        org.apache.commons.io.IOUtils.toString(
            XSKViewParserTest.class.getResourceAsStream(
                "/test/xsk/com/sap/MissingPropSequence.hdbsequence"),
            StandardCharsets.UTF_8);

    assertThrows(
        XSKHDBSequenceMissingPropertyException.class,
        () -> {
          new XSKHDBSequenceParser()
              .parse("/test/xsk/com/sap/MissingPropSequence.hdbsequence", content);
        });
  }
  ...
  public void parseRepetitiveProperties() throws Exception {
    String content =
        org.apache.commons.io.IOUtils.toString(
            XSKViewParserTest.class.getResourceAsStream(
                "/test/xsk/com/sap/RepetitivePropsSequence.hdbsequence"),
            StandardCharsets.UTF_8);

    assertThrows(
        XSKHDBSequenceDuplicatePropertyException.class,
        () -> {
          new XSKHDBSequenceParser()
              .parse("/test/xsk/com/sap/RepetitivePropsSequence.hdbsequence", content);
        });
  }
  ...
  public void parseRandomlyOrderedContent() throws Exception {
    String content =
        org.apache.commons.io.IOUtils.toString(
            XSKViewParserTest.class.getResourceAsStream(
                "/test/xsk/com/sap/RandomlyOrderedSequence.hdbsequence"),
            StandardCharsets.UTF_8);
    XSKDataStructureHDBSequenceModel model =
        (XSKDataStructureHDBSequenceModel)
            new XSKHDBSequenceParser()
