...
public class XSKDataStructuresSynchronizerJobDefinitionProvider implements IJobDefinitionProvider {
  ...
  private static final String DIRIGIBLE_JOB_EXPRESSION_XSK_DATA_STRUCTURE =
      "DIRIGIBLE_JOB_EXPRESSION_XSK_DATA_STRUCTURE";

  private static final String DIRIGIBLE_INTERNAL_XSK_DATA_STRUCTURES_SYNCHRONIZER_JOB =
      "dirigible-internal-xsk-data-structures-synchronizer-job";
  ...
  public JobDefinition getJobDefinition() {
    ...
    jobDefinition.setExpression(
        Configuration.get(DIRIGIBLE_JOB_EXPRESSION_XSK_DATA_STRUCTURE, "0/30 * * * * ?"));
