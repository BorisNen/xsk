...
public interface IXSKSecureStoreCoreService {
  ...
  void createSecureStoreValue(String storeId, String userId, String dataId, String value)
      throws XSKSecureStoreException;

  void updateSecureStoreValue(XSKSecureStoreContent xskSecureStoreContent)
      throws XSKSecureStoreException;

  XSKSecureStoreContent findSecureStoreContent(String storeId, String userId, String dataId)
      throws XSKSecureStoreException;

  void deleteSecureStoreValue(String storeId, String userId, String dataId)
      throws XSKSecureStoreException;

  void deleteSecureStoreValuesByStoreId(String storeId) throws XSKSecureStoreException;

  boolean existsSecureStoreContent(String storeId, String userId, String dataId)
      throws XSKSecureStoreException;
}
