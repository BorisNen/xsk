...
@Path("/xsk")
@Api(
    value = "JavaScript Engine - HANA XS Classic",
    authorizations = {
      @Authorization(
          value = "basicAuth",
          scopes = {})
...
public class XSKJavascriptEngineRestService extends AbstractRestService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(XSKJavascriptEngineRestService.class);

  @Inject private XSKJavascriptEngineProcessor processor;
