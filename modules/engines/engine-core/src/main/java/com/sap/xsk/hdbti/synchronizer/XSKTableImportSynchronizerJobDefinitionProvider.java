...
public class XSKTableImportSynchronizerJobDefinitionProvider implements IJobDefinitionProvider {
  ...
  private static final String DIRIGIBLE_JOB_EXPRESSION_XSK_TABLE_IMPORT =
      "DIRIGIBLE_JOB_EXPRESSION_XSK_TABLE_IMPORT";

  private static final String DIRIGIBLE_INTERNAL_XSK_TABLE_IMPORT_SYNCHRONIZER_JOB =
      "dirigible-internal-xsk-table-import-synchronizer-job";
  ...
  public JobDefinition getJobDefinition() {
    ...
    jobDefinition.setExpression(
        Configuration.get(DIRIGIBLE_JOB_EXPRESSION_XSK_TABLE_IMPORT, "0/45 * * * * ?"));
