...
public class XSKTableImportArtifact extends XSKDataStructureModel {
  ...
  public void setTableImportToCsvRelations(
      List<XSKTableImportToCsvRelation> tableImportToCsvRelations) {
  ...
  public void setImportConfigurationDefinition(
      List<XSKTableImportConfigurationDefinition> importConfigurationDefinition) {
