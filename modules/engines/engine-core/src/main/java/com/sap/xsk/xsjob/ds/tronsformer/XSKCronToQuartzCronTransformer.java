...
public class XSKCronToQuartzCronTransformer {
  ...
  private String parseDayOfWeekElement(String dayOfWeekElement) throws ParseException {
    if (dayOfWeekElement.equals("*") && xskCronExpressionArr[XSK_CRON_DAY].equals("*")) {
      return "?";
    ...
    throw new XSKCronExpressionException(
        String.join(" ", xskCronExpressionArr), XSK_CRON_DAY_OF_WEEK);
  }
}
