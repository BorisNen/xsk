...
public class XSKDataStructureHDBTableConstraintsModel {
  ...
  private List<XSKDataStructureHDBTableConstraintForeignKeyModel> foreignKeys =
      new ArrayList<XSKDataStructureHDBTableConstraintForeignKeyModel>();

  private List<XSKDataStructureHDBTableConstraintUniqueModel> uniqueIndices =
      new ArrayList<XSKDataStructureHDBTableConstraintUniqueModel>();

  private List<XSKDataStructureHDBTableConstraintCheckModel> checks =
      new ArrayList<XSKDataStructureHDBTableConstraintCheckModel>();
