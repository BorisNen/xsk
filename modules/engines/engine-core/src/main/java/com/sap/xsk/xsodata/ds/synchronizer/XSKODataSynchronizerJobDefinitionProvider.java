...
public class XSKODataSynchronizerJobDefinitionProvider implements IJobDefinitionProvider {
  ...
  private static final String DIRIGIBLE_JOB_EXPRESSION_XSK_ODATA =
      "DIRIGIBLE_JOB_EXPRESSION_XSK_ODATA";

  private static final String DIRIGIBLE_INTERNAL_XSK_ODATA_SYNCHRONIZER_JOB =
      "dirigible-internal-xsk-odata-synchronizer-job";
  ...
  public JobDefinition getJobDefinition() {
    ...
    jobDefinition.setExpression(
        Configuration.get(DIRIGIBLE_JOB_EXPRESSION_XSK_ODATA, "0/55 * * * * ?"));
