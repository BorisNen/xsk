...
public class XSKHDBSequenceCreateProcessor
  ...
  private String getHanav1ModelSQL(
      XSKDataStructureHDBSequenceModel hdbSequenceModel, String modifiedSequenceName) {
