...
public class XSKODataModelFactory {
  ...
  public XSKODataModel parseOData(String location, String content) throws Exception {
    ...
    for (Iterator iterator = xsOData.getElements().iterator(); iterator.hasNext(); ) {
      com.sap.xsk.models.xsodata.xsOData.Type type =
          (com.sap.xsk.models.xsodata.xsOData.Type) iterator.next();
      if (type instanceof Service) {
        com.sap.xsk.models.xsodata.xsOData.Service service =
            (com.sap.xsk.models.xsodata.xsOData.Service) type;
        ...
        while (iteratorEntities.hasNext()) {
          ...
          for (Iterator iteratorNavigates = eEntity.getNavigates().iterator();
              iteratorNavigates.hasNext(); ) {
