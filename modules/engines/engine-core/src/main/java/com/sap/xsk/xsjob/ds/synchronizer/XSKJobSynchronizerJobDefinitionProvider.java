...
public class XSKJobSynchronizerJobDefinitionProvider implements IJobDefinitionProvider {
  ...
  private static final String DIRIGIBLE_INTERNAL_XSK_JOB_SYNCHRONIZER_JOB =
      "dirigible-internal-xsk-job-synchronizer-job";
  ...
  public JobDefinition getJobDefinition() {
    ...
    jobDefinition.setExpression(
        Configuration.get(DIRIGIBLE_JOB_EXPRESSION_XSK_JOB, "0/20 * * * * ?"));
