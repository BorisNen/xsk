...
public class HDBCalculationViewDropProcessor extends HDBCalculationViewAbstractProcessor {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(HDBCalculationViewDropProcessor.class);
  ...
  private void deployContainerDropContent(
    ...
    for (XSKDataStructureHDBCalculationViewModel next : hdbCalculationViews) {
      executeUpdate(
          connection,
          "INSERT INTO #UNDEPLOY_PATHS (PATH) VALUES ('" + next.getLocation().substring(1) + "');");
    }
