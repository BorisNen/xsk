...
public class XSKHDBTableFunctionParser
    implements XSKDataStructureParser<XSKDataStructureHDBTableFunctionModel> {

  private String extractTableFunctionNameFromContent(String content)
  ...
  @Override
  public XSKDataStructureHDBTableFunctionModel parse(String location, String content)
      throws XSKDataStructuresException {
    XSKDataStructureHDBTableFunctionModel hdbTableFunction =
        new XSKDataStructureHDBTableFunctionModel();
