...
public class XSKSecureStoreSynchronizerJobDefinitionProvider implements IJobDefinitionProvider {
  ...
  private static final String DIRIGIBLE_JOB_EXPRESSION_XSK_SECURE_STORE =
      "DIRIGIBLE_JOB_EXPRESSION_XSK_SECURE_STORE";

  private static final String
      DIRIGIBLE_INTERNAL_XSK_SECURE_CREATE_SECURE_STORE_VALUE_SYNCHRONIZER_JOB =
          "dirigible-internal-xsk-secure-store-synchronizer-job";
  ...
  public JobDefinition getJobDefinition() {
    ...
    jobDefinition.setExpression(
        Configuration.get(DIRIGIBLE_JOB_EXPRESSION_XSK_SECURE_STORE, "0/25 * * * * ?"));
