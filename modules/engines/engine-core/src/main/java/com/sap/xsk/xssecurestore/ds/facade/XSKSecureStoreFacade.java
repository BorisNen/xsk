...
public class XSKSecureStoreFacade implements IScriptingFacade {
  ...
  private static final XSKSecureStoreCoreService xskSecureStoreCoreService =
      StaticInjector.getInjector().getInstance(XSKSecureStoreCoreService.class);

  public XSKSecureStoreFacade() {}

  public static final void store(String storeId, String dataId, String value)
      throws XSKSecureStoreException {
    xskSecureStoreCoreService.createSecureStoreValue(
        storeId, IXSKSecureStoreModel.VALUE_APP_USER, dataId, value);
  }
  ...
  public static final String read(String storeId, String dataId) throws XSKSecureStoreException {
    XSKSecureStoreContent xskSecureStoreContent =
        xskSecureStoreCoreService.findSecureStoreContent(
            storeId, IXSKSecureStoreModel.VALUE_APP_USER, dataId);
  ...
  public static final void remove(String storeId, String dataId) throws XSKSecureStoreException {
    xskSecureStoreCoreService.deleteSecureStoreValue(
        storeId, IXSKSecureStoreModel.VALUE_APP_USER, dataId);
  }

  public static final String readForUser(String storeId, String dataId)
      throws XSKSecureStoreException {
    XSKSecureStoreContent xskSecureStoreContent =
        xskSecureStoreCoreService.findSecureStoreContent(storeId, UserFacade.getName(), dataId);
  ...
  public static final void storeForUser(String storeId, String dataId, String value)
      throws XSKSecureStoreException {
    xskSecureStoreCoreService.createSecureStoreValue(storeId, UserFacade.getName(), dataId, value);
  }

  public static final void removeForUser(String storeId, String dataId)
      throws XSKSecureStoreException {
