...
public class XSKDataStructureModelFactory {
   ...
   * @throws Exception
   */
  public XSKDataStructureEntitiesModel parseEntities(String location, String content)
      throws Exception {
   ...
   * @throws Exception
   */
  public XSKDataStructureEntitiesModel parseEntities(String location, byte[] bytes)
      throws Exception {
  ...
  //		XSKDataStructureCalculationViewModel calcviewModel = new
  // XSKDataStructureCalculationViewModel();
