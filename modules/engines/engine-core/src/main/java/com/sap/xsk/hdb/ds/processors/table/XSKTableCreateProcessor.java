    ...
    if (tableModel.getConstraints() != null) {
      if (tableModel.getConstraints().getPrimaryKey() != null) {
        String[] primaryKeyColumns =
            new String[tableModel.getConstraints().getPrimaryKey().getColumns().length];
        int i = 0;
      ...
      if (tableModel.getConstraints().getForeignKeys() != null) {
        for (XSKDataStructureHDBTableConstraintForeignKeyModel foreignKey :
          ...
          String[] foreignKeyReferencedColumns =
              new String[foreignKey.getReferencedColumns().length];
          i = 0;
      ...
      if (tableModel.getConstraints().getUniqueIndices() != null) {
        for (XSKDataStructureHDBTableConstraintUniqueModel uniqueIndex :
            tableModel.getConstraints().getUniqueIndices()) {
      ...
      if (tableModel.getConstraints().getChecks() != null) {
        for (XSKDataStructureHDBTableConstraintCheckModel check :
            tableModel.getConstraints().getChecks()) {
