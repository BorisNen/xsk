...
@XmlType(
    name = "Entity",
    propOrder = {"inlineHierarchy", "index", "partitionSpecification", "tableGroup"})
public class Entity extends StructureType {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link InlineHierarchy }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PartitionSpecification }
   */
