...
public class ObjectFactory {
  ...
  private static final QName _Scenario_QNAME =
      new QName("http://www.sap.com/ndb/BiModelCalculation.ecore", "scenario");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: com.sap.ndb.bimodelcalculation
   */
  ...
  public JAXBElement<CalculationScenario> createScenario(CalculationScenario value) {
    return new JAXBElement<CalculationScenario>(
        _Scenario_QNAME, CalculationScenario.class, null, value);
  }
}
