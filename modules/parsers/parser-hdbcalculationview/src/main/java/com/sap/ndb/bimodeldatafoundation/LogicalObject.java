...
@XmlType(
    name = "LogicalObject",
    propOrder = {"attributes", "calculatedAttributes", "allAttributes", "privateDataFoundation"})
...
public class LogicalObject extends InformationModel {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AbstractAttribute }
   */
