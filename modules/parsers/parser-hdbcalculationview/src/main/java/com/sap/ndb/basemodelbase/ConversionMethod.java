...
public enum ConversionMethod {
   ...
   * row in the right table and vice versa. If this join type is selected the engine can better
   * optimize the queries, because the join can be completely ignored if no fields are requested
