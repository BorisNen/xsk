...
@XmlType(
    name = "AnonymizeParameterization",
    propOrder = {
      "seqColumn",
      "k",
      "loss",
...
public class AnonymizeParameterization {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link QidColumn }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link QidColumnHierarchy }
   */
