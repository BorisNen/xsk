...
@XmlType(
    ...
    propOrder = {"valueFilter", "hierarchyFilter", "procedureFilter"})
public class AttributeFilter extends Filter {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ValueFilter }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link HierarchyFilter }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ProcedureFilter }
   */
