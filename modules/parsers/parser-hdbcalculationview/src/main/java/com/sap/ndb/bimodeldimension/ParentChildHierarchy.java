...
@XmlType(
    name = "ParentChildHierarchy",
    propOrder = {"attributeParentPair", "siblingOrder", "timeProperties", "edgeAttribute"})
public class ParentChildHierarchy extends Hierarchy {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AttributeParentPair }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SiblingOrder }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link EdgeAttribute }
   */
