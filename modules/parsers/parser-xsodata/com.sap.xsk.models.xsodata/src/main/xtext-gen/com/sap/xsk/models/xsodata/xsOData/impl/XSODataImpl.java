 ...
 *
 * <ul>
 *   <li>{@link com.sap.xsk.models.xsodata.xsOData.impl.XSODataImpl#getElements <em>Elements</em>}
 * </ul>
 *
 * @generated
 */
public class XSODataImpl extends MinimalEObjectImpl.Container implements XSOData {
  ...
  public EList<Type> getElements() {
    if (elements == null) {
      elements =
          new EObjectContainmentEList<Type>(Type.class, this, XsODataPackage.XSO_DATA__ELEMENTS);
    }
    return elements;
  }
