...
public class XsODataAdapterFactory extends AdapterFactoryImpl {
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.sap.xsk.models.xsodata.xsOData.XSOData
   * <em>XSO Data</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.sap.xsk.models.xsodata.xsOData.Type
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.sap.xsk.models.xsodata.xsOData.Service
   * <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.sap.xsk.models.xsodata.xsOData.Entity
   * <em>Entity</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   ...
   * com.sap.xsk.models.xsodata.xsOData.Navigation <em>Navigation</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * com.sap.xsk.models.xsodata.xsOData.Association <em>Association</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
