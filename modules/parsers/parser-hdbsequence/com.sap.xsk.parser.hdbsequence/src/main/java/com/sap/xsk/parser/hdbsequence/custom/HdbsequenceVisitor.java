...
public class HdbsequenceVisitor extends HdbsequenceBaseVisitor<JsonElement> {
  ...
  private void checkForPropertyRepetition(String property)
      throws XSKHDBSequenceDuplicatePropertyException {
    if (!visitedProperties.contains(property)) {
      visitedProperties.add(property);
    } else {

      throw new XSKHDBSequenceDuplicatePropertyException(
          String.format("Property %s is already declared!", property));
    }
  }
  ...
  public JsonElement visitHdbsequence(@NotNull HdbsequenceParser.HdbsequenceContext ctx) {
    ...
    for (ParseTree tree : ctxList) {
      if (tree.getChild(0) instanceof HdbsequenceParser.SchemaContext) {
        parsedObj.add(
            HDBSequenceConstants.SCHEMA_PROPERTY,
            visitSchema((HdbsequenceParser.SchemaContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.PubliccContext) {
        parsedObj.add(
            HDBSequenceConstants.PUBLIC_PROPERTY,
            visitPublicc((HdbsequenceParser.PubliccContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.MaxvalueContext) {
        parsedObj.add(
            HDBSequenceConstants.MAXVALUE_PROPERTY,
            visitMaxvalue((HdbsequenceParser.MaxvalueContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.Depends_onContext) {
        parsedObj.add(
            HDBSequenceConstants.DEPENDS_ON_PROPERTY,
            visitDepends_on((HdbsequenceParser.Depends_onContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.NomaxvalueContext) {
        parsedObj.add(
            HDBSequenceConstants.NOMAXVALUE_PROPERTY,
            visitNomaxvalue((HdbsequenceParser.NomaxvalueContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.Depends_on_tableContext) {
        parsedObj.add(
            HDBSequenceConstants.DEPENDS_ON_TABLE_PROPERTY,
        ...
        parsedObj.add(
            HDBSequenceConstants.NOMINVALUE_PROPERTY,
            visitNominvalue((HdbsequenceParser.NominvalueContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.CyclesContext) {
        parsedObj.add(
            HDBSequenceConstants.CYCLES_PROPERTY,
            visitCycles((HdbsequenceParser.CyclesContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.MinvalueContext) {
        parsedObj.add(
            HDBSequenceConstants.MINVALUE_PROPERTY,
            visitMinvalue((HdbsequenceParser.MinvalueContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.Depends_on_viewContext) {
        parsedObj.add(
            HDBSequenceConstants.DEPENDS_ON_VIEW_PROPERTY,
        ...
        parsedObj.add(
            HDBSequenceConstants.RESET_BY_PROPERTY,
            visitReset_by((HdbsequenceParser.Reset_byContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.Increment_byContext) {
        parsedObj.add(
            HDBSequenceConstants.INCREMENT_BY_PROPERTY,
            visitIncrement_by((HdbsequenceParser.Increment_byContext) tree.getChild(0)));
      } else if (tree.getChild(0) instanceof HdbsequenceParser.Start_withContext) {
        parsedObj.add(
            HDBSequenceConstants.START_WITH_PROPERTY,
            visitStart_with((HdbsequenceParser.Start_withContext) tree.getChild(0)));
      }
    }
    return parsedObj;
  }
  ...
  public JsonElement visitSchema(@NotNull HdbsequenceParser.SchemaContext ctx) {
    ...
    return (ctx != null && ctx.STRING() != null) ? new JsonPrimitive(ctx.STRING().getText()) : null;
  }
  ...
  @Override
  public JsonElement visitDepends_on_table(HdbsequenceParser.Depends_on_tableContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
  ...
  @Override
  public JsonElement visitNominvalue(HdbsequenceParser.NominvalueContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
  ...
  @Override
  public JsonElement visitCycles(HdbsequenceParser.CyclesContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
  ...
  @Override
  public JsonElement visitMinvalue(HdbsequenceParser.MinvalueContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
  ...
  @Override
  public JsonElement visitDepends_on_view(HdbsequenceParser.Depends_on_viewContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
  ...
  @Override
  public JsonElement visitReset_by(HdbsequenceParser.Reset_byContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
  ...
  @Override
  public JsonElement visitIncrement_by(HdbsequenceParser.Increment_byContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
  ...
  @Override
  public JsonElement visitStart_with(HdbsequenceParser.Start_withContext ctx)
      throws XSKHDBSequenceDuplicatePropertyException {
