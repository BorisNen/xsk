...
public class HdbsynonymParser extends Parser {
  ...
  public static final int T__4 = 1,
      T__3 = 2,
      T__2 = 3,
      T__1 = 4,
      T__0 = 5,
  ...
  public static final int RULE_hdbsynonymDefinition = 0,
      RULE_location = 1,
      RULE_synonymBody = 2,
      RULE_synonymTarget = 3,
      RULE_synonymTargetProp = 4,
      RULE_synonymSchema = 5;
  public static final String[] ruleNames = {
    "hdbsynonymDefinition",
    "location",
    "synonymBody",
    "synonymTarget",
    "synonymTargetProp",
