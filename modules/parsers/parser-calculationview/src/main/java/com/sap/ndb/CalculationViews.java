...
public class CalculationViews {
  ...
  public static class CalculationView {
    ...
    public static class Input {
       ...
       * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
       * modification you make to the returned list will be present inside the JAXB object. This is
       * why there is not a <CODE>set</CODE> method for the mapping property.
       *
       * <p>For example, to add a new item, do as follows:
       *
       * <pre>
       ...
       *
       * <p>Objects of the following type(s) are allowed in the list {@link
       * CalculationViews.CalculationView.Input.Mapping }
       */
    ...
    public static class ViewAttributes {
       ...
       * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
       * modification you make to the returned list will be present inside the JAXB object. This is
       * why there is not a <CODE>set</CODE> method for the viewAttribute property.
       *
       * <p>For example, to add a new item, do as follows:
       *
       * <pre>
       ...
       *
       * <p>Objects of the following type(s) are allowed in the list {@link
       * CalculationViews.CalculationView.ViewAttributes.ViewAttribute }
       */
      public List<CalculationViews.CalculationView.ViewAttributes.ViewAttribute>
          getViewAttribute() {
        if (viewAttribute == null) {
          viewAttribute =
              new ArrayList<CalculationViews.CalculationView.ViewAttributes.ViewAttribute>();
        }
