...
public class Layout {
  ...
  public static class Shapes {
     ...
     * why there is not a <CODE>set</CODE> method for the shape property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link Layout.Shapes.Shape }
     */
    ...
    @XmlType(
        name = "",
        propOrder = {"upperLeftCorner", "rectangleSize"})
