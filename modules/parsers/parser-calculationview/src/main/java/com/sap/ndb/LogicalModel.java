...
public class LogicalModel {
  ...
  public static class BaseMeasures {
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the measure property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * LogicalModel.BaseMeasures.Measure }
     */
    ...
    @XmlType(
        name = "",
        propOrder = {"descriptions", "measureMapping"})
  ...
  public static class CalculatedMeasures {
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * LogicalModel.CalculatedMeasures.Measure }
     */
    ...
    @XmlType(
        name = "",
        propOrder = {"descriptions", "exceptionAggregation", "formula"})
    public static class Measure {
       ...
       *     LogicalModel.CalculatedMeasures.Measure.ExceptionAggregation }
       */
      public void setExceptionAggregation(
          LogicalModel.CalculatedMeasures.Measure.ExceptionAggregation value) {
      ...
      public static class ExceptionAggregation {
        ...
        protected List<LogicalModel.CalculatedMeasures.Measure.ExceptionAggregation.Attribute>
            attribute;
         ...
         */
        public List<LogicalModel.CalculatedMeasures.Measure.ExceptionAggregation.Attribute>
            getAttribute() {
          if (attribute == null) {
            attribute =
                new ArrayList<
  ...
  public static class LocalDimensions {
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the localDimension property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * LogicalModel.LocalDimensions.LocalDimension }
     */
    ...
    @XmlType(
        name = "",
        propOrder = {"attributeRef", "hierarchies"})
    public static class LocalDimension {
       ...
       * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
       * modification you make to the returned list will be present inside the JAXB object. This is
       * why there is not a <CODE>set</CODE> method for the attributeRef property.
       *
       * <p>For example, to add a new item, do as follows:
       *
       * <pre>
      ...
      public static class Hierarchies {
        ...
        public void setHierarchy(
            LogicalModel.LocalDimensions.LocalDimension.Hierarchies.Hierarchy value) {
        ...
        @XmlType(
            name = "",
            propOrder = {"descriptions", "levels"})
        public static class Hierarchy {

          @XmlElement(required = true)
          protected LogicalModel.LocalDimensions.LocalDimension.Hierarchies.Hierarchy.Descriptions
              descriptions;
          ...
          public void setLevels(
              LogicalModel.LocalDimensions.LocalDimension.Hierarchies.Hierarchy.Levels value) {
            this.levels = value;
          }
          ...
          public static class Levels {
             ...
             * JAXB object. This is why there is not a <CODE>set</CODE> method for the level
             * property.
             *
             * <p>For example, to add a new item, do as follows:
             *
  ...
  @XmlType(
      name = "",
      propOrder = {"tableProxies", "joins", "layout"})
