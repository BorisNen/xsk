...
public class HdbtableParser extends Parser {
  ...
  public static final int RULE_hdbtableDefinition = 0,
      RULE_schemaNameProp = 1,
      RULE_temporaryProp = 2,
      RULE_tableTypeProp = 3,
      RULE_publicProp = 4,
      RULE_loggingTypeProp = 5,
      RULE_tableColumnsProp = 6,
      RULE_tableIndexesProp = 7,
      RULE_tablePrimaryKeyProp = 8,
      RULE_tablePrimaryKeyColumnsProp = 9,
      RULE_tablePrimaryKeyIndexTypeProp = 10,
      RULE_descriptionProp = 11,
      RULE_columnsObject = 12,
      RULE_indexesObject = 13,
      RULE_columnAssignName = 14,
      RULE_columnAssignSQLType = 15,
      RULE_columnAssignNullable = 16,
      RULE_columnAssignUnique = 17,
      RULE_columnAssignLength = 18,
      RULE_columnAssignComment = 19,
      RULE_columnAssignDefaultValue = 20,
      RULE_columnAssignPrecision = 21,
      RULE_columnAssignScale = 22,
      RULE_indexAssignName = 23,
      RULE_indexAssignUnique = 24,
      RULE_indexAssignOrder = 25,
      RULE_indexAssignIndexColumns = 26,
      RULE_indexAssignIndexType = 27,
      RULE_indexColumnsArray = 28;
  ...
  public final TablePrimaryKeyColumnsPropContext tablePrimaryKeyColumnsProp()
      throws RecognitionException {
    TablePrimaryKeyColumnsPropContext _localctx =
        new TablePrimaryKeyColumnsPropContext(_ctx, getState());
  ...
  public final TablePrimaryKeyIndexTypePropContext tablePrimaryKeyIndexTypeProp()
      throws RecognitionException {
    TablePrimaryKeyIndexTypePropContext _localctx =
        new TablePrimaryKeyIndexTypePropContext(_ctx, getState());
  ...
  public final ColumnAssignDefaultValueContext columnAssignDefaultValue()
      throws RecognitionException {
    ColumnAssignDefaultValueContext _localctx =
        new ColumnAssignDefaultValueContext(_ctx, getState());
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _la = _input.LA(1);
        if (!((((_la) & ~0x3f) == 0
            && ((1L << _la) & ((1L << STRING) | (1L << INT) | (1L << DATETIMEDEFAULTVALUES)))
                != 0))) {
  ...
  public final IndexAssignIndexColumnsContext indexAssignIndexColumns()
      throws RecognitionException {
