...
public class XSKHDBTABLECoreVisitor extends HdbtableBaseVisitor<JsonElement> {
  ...
  public JsonElement visitIndexAssignIndexType(HdbtableParser.IndexAssignIndexTypeContext ctx) {
    return (ctx != null && ctx.INDEXTYPE() != null)
        ? new JsonPrimitive(ctx.INDEXTYPE().getText())
        : null;
  }
  ...
  public JsonElement visitHdbtableDefinition(HdbtableParser.HdbtableDefinitionContext ctx) {
    ...
    hdbtableObject.add(
        "indexType", visitTablePrimaryKeyIndexTypeProp(ctx.tablePrimaryKeyIndexTypeProp()));
  ...
  @Override
  public JsonElement visitColumnAssignDefaultValue(
      HdbtableParser.ColumnAssignDefaultValueContext ctx) {
  ...
  public JsonElement visitColumnAssignName(HdbtableParser.ColumnAssignNameContext ctx) {
    return (ctx != null && ctx.STRING() != null)
        ? new JsonPrimitive(handleStringLiteral(ctx.STRING().getText()))
        : null;
  }

  @Override
  public JsonElement visitIndexAssignIndexColumns(
      HdbtableParser.IndexAssignIndexColumnsContext ctx) {
    return (ctx != null && ctx.indexColumnsArray() != null)
        ? visitIndexColumnsArray(ctx.indexColumnsArray())
        : new JsonArray();
  }
  ...
  public JsonElement visitTableTypeProp(HdbtableParser.TableTypePropContext ctx) {
    return (ctx != null && ctx.TABLETYPE() != null)
        ? new JsonPrimitive(ctx.TABLETYPE().getText())
        : null;
  }
  ...
  public JsonElement visitTablePrimaryKeyProp(HdbtableParser.TablePrimaryKeyPropContext ctx) {
    return (ctx != null && ctx.tablePrimaryKeyColumnsProp() != null)
        ? visitTablePrimaryKeyColumnsProp(ctx.tablePrimaryKeyColumnsProp())
        : new JsonArray();
  }
  ...
  public JsonElement visitColumnsObject(HdbtableParser.ColumnsObjectContext ctx) {
    ...
    columnsObject.add(
        "defaultValue", visitColumnAssignDefaultValue(ctx.columnAssignDefaultValue()));
  ...
  public JsonElement visitColumnAssignSQLType(HdbtableParser.ColumnAssignSQLTypeContext ctx) {
    return (ctx != null && ctx.SQLTYPES() != null)
        ? new JsonPrimitive(ctx.SQLTYPES().getText())
        : null;
  }
  ...
  public JsonElement visitLoggingTypeProp(HdbtableParser.LoggingTypePropContext ctx) {
    return (ctx != null && ctx.TABLELOGGINGTYPE() != null)
        ? new JsonPrimitive(ctx.TABLELOGGINGTYPE().getText())
        : null;
  }
  ...
  @Override
  public JsonElement visitTablePrimaryKeyIndexTypeProp(
      HdbtableParser.TablePrimaryKeyIndexTypePropContext ctx) {
    return (ctx != null && ctx.INDEXTYPE() != null)
        ? new JsonPrimitive(ctx.INDEXTYPE().getText())
        : null;
  }
  ...
  @Override
  public JsonElement visitTablePrimaryKeyColumnsProp(
      HdbtableParser.TablePrimaryKeyColumnsPropContext ctx) {
