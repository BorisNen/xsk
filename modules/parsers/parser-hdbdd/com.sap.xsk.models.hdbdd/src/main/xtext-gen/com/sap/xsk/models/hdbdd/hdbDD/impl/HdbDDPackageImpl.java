...
public class HdbDDPackageImpl extends EPackageImpl implements HdbDDPackage {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link HdbDDPackage#eINSTANCE} when that field is
  ...
  public static HdbDDPackage init() {
    ...
    HdbDDPackageImpl theHdbDDPackage =
        (HdbDDPackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HdbDDPackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new HdbDDPackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEClass(
        fieldPrimitiveEClass,
        FieldPrimitive.class,
        "FieldPrimitive",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getFieldPrimitive_Key(),
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getFieldPrimitive_FieldPredefinedType(),
        ecorePackage.getEString(),
        "fieldPredefinedType",
        null,
        0,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getFieldType_FieldPredefinedType(),
        ecorePackage.getEString(),
        "fieldPredefinedType",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getFieldReference_ReferenceType(),
        ecorePackage.getEString(),
        "referenceType",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getFieldReference_FieldReferenceEntity(),
        ecorePackage.getEString(),
        ...
        IS_ORDERED);
    initEAttribute(
        getFieldReference_FieldReferenceEntityLocalId(),
        ecorePackage.getEString(),
        ...
        IS_ORDERED);
    initEAttribute(
        getFieldReference_FieldReferenceEntityForeignId(),
        ecorePackage.getEString(),
