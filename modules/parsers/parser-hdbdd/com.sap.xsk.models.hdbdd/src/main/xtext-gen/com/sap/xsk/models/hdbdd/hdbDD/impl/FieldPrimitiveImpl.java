 ...
 *
 * <ul>
 *   <li>{@link com.sap.xsk.models.hdbdd.hdbDD.impl.FieldPrimitiveImpl#isKey <em>Key</em>}
 *   <li>{@link com.sap.xsk.models.hdbdd.hdbDD.impl.FieldPrimitiveImpl#getFieldType <em>Field
 *       Type</em>}
 *   <li>{@link com.sap.xsk.models.hdbdd.hdbDD.impl.FieldPrimitiveImpl#getFieldLength <em>Field
 *       Length</em>}
 *   <li>{@link com.sap.xsk.models.hdbdd.hdbDD.impl.FieldPrimitiveImpl#getFieldPredefinedType
 *       <em>Field Predefined Type</em>}
 * </ul>
 *
 * @generated
 */
public class FieldPrimitiveImpl extends FieldImpl implements FieldPrimitive {
  ...
  /**
   * The default value of the '{@link #getFieldPredefinedType() <em>Field Predefined Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getFieldPredefinedType() <em>Field Predefined Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, HdbDDPackage.FIELD_PRIMITIVE__KEY, oldKey, key));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              HdbDDPackage.FIELD_PRIMITIVE__FIELD_TYPE,
              oldFieldType,
              fieldType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              HdbDDPackage.FIELD_PRIMITIVE__FIELD_LENGTH,
              oldFieldLength,
              fieldLength));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              HdbDDPackage.FIELD_PRIMITIVE__FIELD_PREDEFINED_TYPE,
              oldFieldPredefinedType,
              fieldPredefinedType));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case HdbDDPackage.FIELD_PRIMITIVE__FIELD_TYPE:
        return FIELD_TYPE_EDEFAULT == null
            ? fieldType != null
            : !FIELD_TYPE_EDEFAULT.equals(fieldType);
      case HdbDDPackage.FIELD_PRIMITIVE__FIELD_LENGTH:
        return fieldLength != FIELD_LENGTH_EDEFAULT;
      case HdbDDPackage.FIELD_PRIMITIVE__FIELD_PREDEFINED_TYPE:
        return FIELD_PREDEFINED_TYPE_EDEFAULT == null
            ? fieldPredefinedType != null
