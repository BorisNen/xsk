...
/**
 * This program starts an HTTP server for testing the web integration of your DSL. Just execute it
 * and point a web browser to http://localhost:8080/
 */
...
public class ServerLauncher {
  public static void main(final String[] args) {
    ...
    final Procedure1<WebAppContext> _function =
        (WebAppContext it) -> {
          ...
          it.setConfigurations(
              new Configuration[] {
                _annotationConfiguration,
                _webXmlConfiguration,
                _webInfConfiguration,
                _metaInfConfiguration
              });
          it.setAttribute(
              WebInfConfiguration.CONTAINER_JAR_PATTERN,
              ".*/com\\.sap\\.xsk\\.models\\.hdbdd\\.web/.*,.*\\.jar");
          it.setInitParameter("org.mortbay.jetty.servlet.Default.useFileMappedBuffer", "false");
        };
    WebAppContext _doubleArrow =
        ObjectExtensions.<WebAppContext>operator_doubleArrow(_webAppContext, _function);
